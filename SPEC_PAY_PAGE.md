# Pay Page (pay.ludens.school) — Премиум токены
...
- выбирает количество `tokens` (1..500),
...
1) **MVP redirect**
   ...
   - редирект на backend `/pay/api/create`
